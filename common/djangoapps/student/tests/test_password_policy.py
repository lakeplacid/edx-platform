...
class TestPasswordPolicy(TestCase):
    ...
    def test_password_not_enough_uppercase(self):
        ...
        self.assertEqual(
            obj['value'],
            "Your password must contain at least 3 uppercase letters.",
        )
    ...
    def test_password_not_enough_lowercase(self):
        ...
        self.assertEqual(
            obj['value'],
            "Your password must contain at least 3 lowercase letters.",
        )
    ...
    def test_not_enough_punctuations(self):
        ...
        self.assertEqual(
            obj['value'],
            "Your password must contain at least 3 punctuation characters.",
        )
    ...
    def test_not_enough_alphabetic_characters(self):
        ...
        self.assertEqual(
            obj['value'],
            "Your password must contain at least 3 letters.",
        )
